...
export interface IpcChannels {
  ...
  readonly TOOL_OPEN: 'tool:open';
  readonly TOOL_HIDE: 'tool:hide';
  readonly TOOL_SET_TAB: 'tool:set-tab';
  readonly PET_DISPATCH_BEHAVIOR: 'pet:dispatch-behavior';
  ...
  readonly WINDOW_DRAG_END: 'window:drag-end';
  readonly SYSTEM_GET_LOAD: 'system:get-load';
...
export const TOOL_OPEN: IpcChannels['TOOL_OPEN'];
export const TOOL_HIDE: IpcChannels['TOOL_HIDE'];
export const TOOL_SET_TAB: IpcChannels['TOOL_SET_TAB'];
export const PET_DISPATCH_BEHAVIOR: IpcChannels['PET_DISPATCH_BEHAVIOR'];
...
export const WINDOW_RESTORE_PET_SIZE: IpcChannels['WINDOW_RESTORE_PET_SIZE'];
  ...
  export const SYSTEM_GET_LOAD: IpcChannels['SYSTEM_GET_LOAD'];
